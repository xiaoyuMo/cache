package com.xiaoyu.cache.script;
...
import com.xiaoyu.cache.CacheUtil;
...
public class JavaScriptParser extends AbstractScriptParser {
	...
	@Override
	public <T> T getElValue(String exp, Object[] arguments, Object retVal, boolean hasRetVal, Class<T> valueType)
			throws Exception {
